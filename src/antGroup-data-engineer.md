...
```
JD:
1. 负责信贷风控平台产品的设计、规划与实施工作，包括风险感知、策略研发、决策引擎、模型和数据等平台的需求梳理与产品设计。
...
Req:
1. 本科以上学历，金融、数学、统计学、计算机科学等相关专业优先；
...
```
JD:
1、主要负责审核、理解模型的评测、美颜效果分析等工作，通过制定科学的评测方法和数据分析方法，挖掘模型效果上的badcase并推动链路上的优化；
...
3. 通过分布式计算和索引技术，持续提高数据研发的效率。,.etc

Req:
1. 计算机或相关学科本科及以上学历，2年以上工作经验；
2. 熟悉JAVA或Python语言，掌握多线程，分布式及大数据处理基本工具；
3. 了解机器学习算法，有大数据处理平台、搜索、图结构、索引、数据清洗、数据合成等开发经验优先。,.etc
...
```
JD:
1.关键场景的攻防技术突破及长期安全对抗能力升级建设；
2.通过网络技术、逆向分析、安卓/浏览器等内核分析与优化、JS混淆加密等技术，搭建全球网络对抗能力体系，解决各类
场景对抗难题。,.etc

Req:
1、具备逆向经验，了解Web/APP常见逆向分析技能，熟练使用IDA、Ghidra、Jeb和Jadx等常用工具对程序进行分析；
2、熟悉主流web爬虫对抗技术：js混淆加密/验证码等；熟知Web安全，了解当前流行的Web漏洞(XSS,SQL Injection,CSRF,etc)
3、熟悉客户端对抗知识，掌握软件静态分析、动态调试、协议抓包、HOOK技术原理、HOOK框架应用。熟悉Android Hook原理，熟悉常见xposed、LSPosed、Magisk、Riru、Frida等HOOKT具。了解AOSP源码、Android系統架构，有Framework、ART、HAL开发经验；
4、熟悉Java/Python/Node.js/Go/Shell等至少一种技术语言；
5、熟悉攻防对抗、移动安全、业务安全、风控各类防御措施等经验者优先；熟悉Puppeteer、Appium、Selenium,.etc
...
```
JD:
1、负责移动终端安全的攻防对抗技术体系建设，确保技术先进性；
2、结合攻防技术&大数据&算法，打造智能化的风险感知&识别&响应体系；
3、解决安全业务问题的同时、助力正向业务发展。,.etc

Req:
1、熟悉营销薅羊毛、机器流量、人脸注入等互联网业务安全风险的攻击原理&识别防控方案；
2、熟悉设备牧场、越狱、HOOK、云手机、模拟点击等攻击的检测方案；
3、精通数据挖掘方法、具备较强的的数据敏感性，善于数据驱动去解决问题；
4、熟悉常见机器学习算法原理，并能熟练应用；
5、熟练掌握c/c++,Java,python,sql中的一种或多种编程语言；
6、拥有良好的沟通能力以及团队合作精神、具备较强的抗压能力以及自驱力。,.etc
...
```
JD:
1. 通过各类渠道获取市场/行业/竞对信息，搭建并不断完善市场、行业、竞对分析体系，从宏观趋势到业务本身相关产品、用户、营销等全方位的分析中挖掘机会点，辅助业务一号位制定清晰合理的战略规划，建立KPI追踪机制，保障战略的有效透传和执行。
...
Req:
1. 五年及以上数据分析及商业决策经验，支付/电商/互联网金融/数据咨询等行业背景，数据科学/数学/统计/计算机等相关专业本科及以上学历；
...
2、与解决方案和交付团队共同合作打造标杆客户，助力商业化持续突破。,.etc
...
5、优秀的分析问题与解决问题能力，良好的团队合作能力和总结能力。,.etc
