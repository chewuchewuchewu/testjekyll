...
```
JD:负责面向蚂蚁大安全的风控解决方案运营管理，推动标准的风控解决方案沉淀并在大安全内部推广落地。
1.主导风控解决方案的设计及运营，从风控链路合理性和体验等方面评估解决方案，并负责落地实施。
2.利用专家经验和数据分析等手段，建设风控操作合理性和体验问题的监控体系，及时发现风控链路中的问题，并推进链路的优化和安全产品能力的迭代优化。
3.对风控业务问题进行分析，发现问题本质并沉淀合理的解决方案，包括合理的链路，平台能力要求和平台使用规范等，通过对链路要求和平台使用规范的推广保障业务解决方案落地，解决业务操作合理性带来的风险和体验问题。,.etc

Req:1.数学、统计、金融、管理科学、计算机等相关专业的硕士或以上学历；有业务风险防控经验者优先；
2.有较好的数据处理基础，具备扎实的数据分析能力，熟练使用至少某一种专业分析工具（SQL、Python、R等）；
3.良好的问题分析、根因发现、方案沉淀和问题解决推动能力，自我驱动，能快速学习及适应新业务，勇于接受挑战、在压力下工作；,.etc
...
```
JD:1、负责蚂蚁星河数据体系和解决方案建设，赋能客群分配，机构服务，资产管理等业务，保障数据的质量和稳定性；
2、负责业务领域核心数据体系的规划设计。在数据技术上，能结合业界技术探索数据服务的增量。在数据化运营和数据能力产品化上，制定数据技术和服务的策略。包括用户标签体系、数据智能化和自动化体系和实时数据体系的建设；
3、规划设计数据服务工具，提升数据研发的工作效率，搭建数据服务的工具/产品，赋能业务同学和业务产品，灵活支撑业务的创新和探索，让数据价值更浸透；
4、负责数据质量、稳定性等数据管理，数据内部共享融通的数据平台，让数据标准更规范、数据获取更高效。,.etc

Req:1、2年以上工作经验，计算机等相关专业本科以上学历 ，具有丰富的数据建模实践经验；
2、精通业务建模、数据仓库建模、精通ETL设计开发，具备体系化的数据质量与数据治理相关经验，有大型项目相关领域深入实践经验，能独立主导完成某一业务领域的整体模型设计，具备跨域的沟通协调能；
...
```
JD:● Reporting to the Group Assurance Lead and supporting the Americas Region Sanctions Compliance Officer, to be the Sanctions Strategy/Controls for Americas & EMEA.
汇报给集团后督主管，并支持Americas & EMEA制裁合规官，负责Americas & EMEA地区的制裁策略/控制工作。

● In accordance with the Sanctions Compliance Officer’s implementation of Sanctions laws and regulations, through Sanctions screening and controls of various business sce,.etc

Req:● Bachelor’s degree or higher, with a preference for majors in Law, Finance, or related fields.本科及以上学历，法律、金融等相关专业优先。
● 3 years of experience in sanctions compliance or related fields.
具备3年以上制裁合规或相关领域的工作经验
● Familiarity with international sanctions regulations, such as those of the UN, EU, and OFAC.
          熟悉国际制裁法规和政策，如UN、EU、OFAC等。
● Knowledge of sanctions compliance-related workflows and tools,,.etc
...
```
JD:1. 通过各类渠道获取市场/行业/竞对信息，搭建并不断完善市场、行业、竞对分析体系，从宏观趋势到业务本身相关产品、用户、营销等全方位的分析中挖掘机会点，辅助业务一号位制定清晰合理的战略规划，建立KPI追踪机制，保障战略的有效透传和执行。
2. 从业务健康度的角度设计业务分析评估体系，设定KPI及核心过程监控指标，并独立完成所有追踪分析，对业务结果给出客观专业评价，对业务发展给出建议和意见并协助落地执行。
3. 根据沉淀的分析思路与框架，与上下游团队协作（如数据技术、数据产品团队）持续完善底层数据资产建设、提炼数据产品需求，并推动数据资产建设及数据产品迭代的落地，持续推动业务部门的数据化运营。,.etc

Req:1. 五年及以上数据分析及商业决策经验，支付/电商/互联网金融/数据咨询等行业背景，数据科学/数学/统计/计算机等相关专业本科及以上学历；
2. 有过数据驱动业务落地的成功经验，解决实际问题，创造实际价值，作为主要的驱动方之一协同实现业务KPI；
3. 具备优秀的业务思维，熟练独立撰写数据分析报告，能高效与业务运营团队进行沟通；
4. 有跨团队/跨部门数据项目的管理经验， 有较强的资源整合能力和推动力；
5. 有全英文环境工作经验，可作为工作语言；
6. 熟练使用SQL、Excel、PPT， 熟练掌握数据分析工具、可视化报表工具、数据工具（ETL, Hive, HQL）、A/B Test等技能。
,.etc
...
```
JD:工作职责：负责 OceanBase 数据传输产品的研发：紧贴公司商业化战略，通过产品和技术创新，提供高效率、低延迟的数据传输解决方案，实现用户价值 —— 解决用户数据库迁移、数据实时同步&订阅、业务双活、异构数据库灾备、数仓&数据湖自动化等数据传输相关问题。
...
4、熟悉 Kafka/RocketMQ/Pulsar 等消息队列产品，熟悉其架构设计和关键技术，有相关开发经验者优先.,.etc
...
```
JD:1、负责牵头消费信贷业务相关数据项目的落地和推进；
2、负责金融同业、业务运营、机构服务，催收等数据项目的开发及解决方案工作；
3、负责协调处理日常业务中的各类消金数据问题，提出完善建议，推动产品、运营等相关团队实施。,.etc

Req:1、有至少5年以上大数据开发及架构经验，熟悉ODPS相关数据开发技术栈，有丰富的海量数据性能处理经验；
2、丰富的数据平台架构经验，熟悉数据仓库建模及ETL设计开发；
...
6、有金融、保险等领域经验优先；
7、有前瞻性的整套数据管理、数据服务等解决方案的规划和落地经验优先考虑。,.etc
